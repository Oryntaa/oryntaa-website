    ...
    <section className="bg-canvas relative overflow-hidden">
      ...
      <Container>
        <div className="relative flex flex-col items-center gap-8 py-24 text-center md:py-32">
          {/* Eyebrow pill, per PAGE_SPECIFICATIONS §2.1. No rating stars: the site carries no
              reviews to back them, and §1 bans claims the founders cannot defend. */}
          <Reveal>
            <span className="border-line bg-surface shadow-card inline-flex items-center rounded-full border px-4 py-2">
